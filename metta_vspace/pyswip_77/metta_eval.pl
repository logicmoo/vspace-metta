...
% =================================================================
% ================================================================
eval_args20(RetType,Depth,Self,['nop',Expr],Empty):- !,  
  ignore(eval_args0(RetType,Depth,Self,Expr,_)), return_empty([],Empty).

eval_args20(RetType,Depth,Self,['do',Expr],[]):- !,
  ignore(eval_args0(RetType,Depth,Self,Expr,_)), return_empty([],_Empty).
...
% =================================================================
% =================================================================
eval_args20(RetType,_Dpth,_Slf,['repl!'],'True'):- !, repl.
eval_args20(RetType,Depth,Self,['!',Cond],Res):- !, call(eval_args0(RetType,Depth,Self,Cond,Res)).
eval_args20(RetType,Depth,Self,['rtrace',Cond],Res):- !, rtrace(eval_args0(RetType,Depth,Self,Cond,Res)).
eval_args20(RetType,Depth,Self,['time',Cond],Res):- !, time(eval_args0(RetType,Depth,Self,Cond,Res)).
eval_args20(RetType,Depth,Self,['print',Cond],Res):- !, eval_args0(RetType,Depth,Self,Cond,Res),format('~N'),print(Res),format('~N').
% !(println! $1)
eval_args20(RetType,Depth,Self,['println!',Cond],Res):- !, eval_args0(RetType,Depth,Self,Cond,Res),format('~N'),print(Res),format('~N').
...
equal_enough_for_test(X,Y):- X ==['Empty'], Y==[[]],!.
equal_enough_for_test(X,Y):- X =='Empty', Y==[[]],!.
equal_enough_for_test(X,Y):- X ==['Empty'], Y==[],!.
...
% =================================================================
% =================================================================
do_metta(_Who,What,Where,PredDecl,_TF):-   
  do_metta(Where,What, PredDecl).
/*
...
bagof_eval(RetType,Depth,Self,X,L):- !,findall(E,eval_args0(RetType,Depth,Self,X,E),L).
