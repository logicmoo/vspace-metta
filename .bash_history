...
git commit -am "removing errant .bash_history files"
git push logicmoo 
find /tmp/flybase/
ls data -l
cd vspace-metta/
...
ls ./data/*/*/*.scm
./INSTALL.md 
./MeTTa -G '!(create-flybase-pl! ./data/ftp.flybase.org/releases/FB2023_05/precomputed_files/)'
tail whole_metta.pl 
tail whole_flybase.pl 
cls
./MeTTa -G '!(create-flybase-pl! ./data/ftp.flybase.org/releases/FB2023_05/precomputed_files/)'
ls -l
rm precomputed_files
ln -s data/ftp.flybase.org/releases/FB2023_05/precomputed_files/
ls
./MeTTa -G '!(create-flybase-pl! ./data/ftp.flybase.org/releases/FB2023_05/precomputed_files/)'
cls
./MeTTa -G '!(create-flybase-pl! ./data/ftp.flybase.org/releases/FB2023_05/precomputed_files/)'
...
find -name "*.*.data" 
find -name "*.datalog" 
cat ./data/12_ontologies/FBcv/FBcv_with_definition_2023-09-15.scm.datalog
find -name "*.datalog" 
cat whole_metta.datalog 
tail whole_metta.datalog 
tail whole_metta.datalog 
list ./precomputed_files/transposons/transposon_sequence_s
list ./precomputed_files/transposons/
ls ./precomputed_files/transposons/
ls ./precomputed_files/
ls ./precomputed_files/transposons/
ls ./precomputed_files/clones/
ls -l
find data
find data/ftp.flybase.org/releases/FB2023_05/
./INSTALL.md 
find data/ftp.flybase.org/ -name "index.htm*"
find data/ftp.flybase.org/ -name "index.htm*" -delete 
./INSTALL.md 
find ./data -type f -name "*.datalog" -exec echo {} +
cat ./data/ftp.flybase.org/releases/FB2023_05/precomputed_files/ontologies/flybase_stock_vocabulary.obo.datalog
cat whole_flybase.datalog 
awk '!seen[$0]++' whole_flybase.datalog > tmpfile && mv tmpfile whole_flybase.datalog
cat whole_flybase.datalog 
gead whole_flybase.datalog 
head whole_flybase.datalog 
tail whole_flybase.datalog 
tail -100 whole_flybase.datalog 
./INSTALL.md 
cls
time ./INSTALL.md 
cls
time ./INSTALL.md 
ls
wc - l whole_flybase.datalog
wc -l whole_flybase.datalog
ls -l whole_flybase.datalog 
ls -lh whole_flybase.datalog 
du . -h -a
cd ../../..
grep ":-" whole_flybase.datalog 
grep "^:-" whole_flybase.datalog 
grep "^ :-" whole_flybase.datalog 
grep fb_pred whole_flybase.datalog 
grep obo-is whole_flybase.datalog 
time swipl -g "qcompile('whole_flybase.datalog')" -t halt
vi whole_header.datalog
cat whole_header.datalog whole_flybase.datalog > whole_metta.datalog
mv whole_metta.datalog whole_flybase.datalog
head whole_flybase.datalog 
sort whole_flybase.datalog > sorted
head sorted \
head sorted 
tail sorted 
cat whole_header.datalog sorted > whole_flybase.datalog
head whole_flybase.datalog 
grep '"' whole_flybase.datalog 
grep '"' whole_flybase.datalog  | grep -v comment
grep "\\\"" whole_flybase.datalog 
grep '\\"' whole_flybase.datalog  | grep -v comment
grep '\\'' whole_flybase.datalog  | grep -v comment
grep '\\\'' whole_flybase.datalog  | grep -v comment
...
ls
./MeTTa
cat whole_flybase.datalog2
tail whole_flybase.datalog2
time swipl -g "qcompile('whole_flybase.datalog')" -t halt
kill -9 %1
./MeTTa
tail whole_flybase.datalog
...
find -name "*.metta"
find data -name "*.metta"
find data -name "*.datalog.metta"
cat data/12_ontologies/DO/DO_2023-09-15.scm.datalog.metta
find data -name "*.datalog.metta"
find data -name "*.datalog2"
cat data/12_ontologies/FBcv/FBcv_with_definition_2023-09-15.scm.datalog2
cat data/12_ontologies/FBcv/FBcv_with_definition_2023-09-15.scm.datalog.metta 
time find ./data -type f -name "*.datalog?*" -print -exec sed -i -e 's/obo-has-definition/obo-def/g' -e 's/obo-Inheritance/Inheritance/g' -e 's/obo-has-name/obo-name/g'  -e 's/obo-[A-Z]+/obo/g'  {} \;
cat data/12_ontologies/FBcv/FBcv_with_definition_2023-09-15.scm.datalog.metta 
find data -name "*.datalog?*"
cat data/12_ontologies/FBcv/FBcv_2023-09-15.scm.datalog2
find data -name "*.datalog?*"
find data -name "*.datalo?*"
cls
find data -name "*.datalo?*"
find data -name "*.datalog?*"
cls
find data -name "*.datalog?*"
ls data/supplimental/
ls data/supplimental/flybase-controlled-vocabulary/
ls
ls data/
rm -rf data/ftp.flybase.org/releases/FB2023_04/
rm -rf data/mozi.ai/datasets/kbs/metta
ls data/tsv_exports
mv data/supplimental data/extra-supplimental
mkdir data/supplimental
mv data/12_ontologies ./data/supplimental/
ls
ls ./data/supplimental/
find ./data/supplimental/
wc -l ./data/supplimental/*.tsv
tail ./data/supplimental/*.tsv
wc -l ./data/supplimental/*.tsv
rm ./data/supplimental/public.pubauthor.tsv ./data/supplimental/public.pub_dbxref.tsv
rm ./data/supplimental/public.pubprop.tsv 
rm ./data/supplimental/public.pub_relationship.tsv 
head ./data/supplimental/public.pub.tsv 
tail ./data/supplimental/public.pub.tsv 
head ./data/supplimental/public.pub.tsv -500
head -500 ./data/supplimental/public.pub.tsv 
time find ./data -type f -name "*.datalog?*" -print -exec wc -l {} +
time find ./data -type f -name "*.datalog2" -print -exec wc -l {} +
time find ./data -type f -name "*.datalog.metta" -print -exec wc -l {} +
time find ./data -type f -name "*.datalog" -print -exec wc -l {} +
cat ./data/ftp.flybase.org/releases/FB2023_05/precomputed_files/ontologies/fly_anatomy.obo.datalog
ls *.qlf
ls *.qlf -l
swipl -l whole_flybase.qlf 
time find ./data -type f -name "*.datalog2" -print -exec wc -l {} +
time find ./data -type f -name "*.datalog.metta" -print -exec wc -l {} +
time find ./data -type f -name "*.obo*" -print -exec wc -l {} +
ls ./data/ftp.flybase.org/releases/FB2023_05/precomputed_files/ontologies/
ls ./data/ftp.flybase.org/releases/FB2023_05/precomputed_files/ontologies/ -l
cat ./data/ftp.flybase.org/releases/FB2023_05/precomputed_files/ontologies/go-basic.obo.datalog
find -name "*.datalog2"
find -name "*.datalog2" -delete 
find -name "*.datalog.metta" -delete 
time find ./data -type f -name "*.datalog?*" -print -exec wc -l {} +
time find ./data -type f -name "*.datalog2" -print -exec wc -l {} +
time find ./data -type f -name "*.datalog.metta" -print -exec wc -l {} +
tail  ./data/ftp.flybase.org/releases/FB2023_05/precomputed_files/alleles/allele_genetic_interactions_fb_2023_05.tsv.datalog.metta
./MeTTa -G '!(datalog_to_termlog!)'
find -name "*.datalog.metta" -delete 
find -name "*.datalog2" -delete 
tail  ./data/ftp.flybase.org/releases/FB2023_05/precomputed_files/alleles/allele_genetic_interactions_fb_2023_05.tsv.datalog.metta
time find ./data -type f -name "*.datalog.metta" -print -exec wc -l {} +
tail ./data/supplimental/12_ontologies/FBcv/FBcv_2023-09-15.scm.datalog.metta
time find ./data -type f -name "*.datalog.metta" -print -exec wc -l {} +
tail  ./data/ftp.flybase.org/releases/FB2023_05/precomputed_files/alleles/fbal_to_fbgn_fb_2023_05.tsv.datalog.metta
time find ./data -type f -name "*.datalog.metta" -print -exec wc -l {} +
find ./data/ -mindepth 1
find ./data/ -mindepth 2
find ./data/ -mindepth 3
...
find ./data -mindepth 2 -type f -name "*.datalog" -exec cat whole_header.datalog {} + > whole_flybase.datalog
find ./data -mindepth 2 -type f -name "*.datalog.metta" -exec cat {} + > whole_flybase.datalog.metta
ls tmpfile 
mv tmpfile whole_flybase.datalog2
wc -l whole_flybase.datalog*
mv whole_* data/
ls
ls
find ./data/ -mindepth 3 -type f -name '*.datalog2' -exec sh -c 'mv -f "$1" "${1%.datalog2}.datalog"' sh {} \;
...
ls 
cat whole_metta.datalog 
cat whole_metta.mettalog 
find ./data/ -type f -printf '%T+ %p\n' | sort
find ./data/ -type f -printf '%T+ %p\n' | sort | head
find ./data/ -type f -printf '%T+ %p\n' | sort -r
find ./data/ -type f -printf '%T+ %p\n' | sort -r | head
metta
cat /opt/logicmoo_workspace/packs_sys/logicmoo_opencog/MeTTa/vspace-metta/precomputed_files/collaborators/fbgn_uniprot_fb_2023_05.tsv.datalog.metta
tail /opt/logicmoo_workspace/packs_sys/logicmoo_opencog/MeTTa/vspace-metta/precomputed_files/collaborators/fbgn_uniprot_fb_2023_05.tsv.datalog.metta
tail /opt/logicmoo_workspace/packs_sys/logicmoo_opencog/MeTTa/vspace-metta/precomputed_files/collaborators/fbgn_uniprot_fb_2023_05.tsv.datalog
./MeTTa
tail precomputed_files/collaborators/pmid_fbgn_uniprot_fb_2023_05.tsv.mettalog 
tail precomputed_files/collaborators/pmid_fbgn_uniprot_fb_2023_05.tsv.???*
rm precomputed_files/collaborators/pmid_fbgn_uniprot_fb_2023_05.tsv.???*
./MeTTa
find ./data/ -type f -name "*.datalog.metta" -exec rename 's/\.datalog\.metta$/.metta/' {} +
find ./data/ -type f -name "*.datalog.metta" -exec rename 's/\.datalog/.metta.datalog/' {} +
find
ls
mkdir .HIDE~
mv backup/ bar old-compat/ prev_* SN \~temp~/
mv Copy/ compat/ ./~temp~/
ls
rm .whole_flybase.qlf.34*
ls
mv \(2\)/ lenat/ ma st.metta Result.html TEST_LINKS.md temp1a.txt fb.qlf ./~DEAD~/ flybase_metta.qlf wfb whole_metta.* ./~temp~/
ls
rm MeTTaLog
ls ??
rm ??
...
rm ???.?*
ls
mv 12_ontologies/ flybase.metta.pl ./~temp~/
ls
ls HVM
ls HVM/b
ls HVM/bench/
ls HVM/bench/work/
ls
rm DEAD.MeTTaLog_final.md 
rm FOUND_UNITS.sortme 
ls
type MeTTa.backed 
ls
rm file_info.tmp 
rm flybase.metta.qlf.gz 
ls
mv metta_vspace_sommeeee/ ./~temp~/
ls
ls prebuilt_metta/
ls -l
rm -rf prebuilt_metta/
ls
cd /opt/logicmoo_workspace/packs_sys/logicmoo_opencog/MeTTa/vspace-metta/T
cd /opt/logicmoo_workspace/packs_sys/logicmoo_opencog/MeTTa/vspace-metta/
cd /opt/logicmoo_workspace/packs_sys/logicmoo_opencog/MeTTa/vspace-metta/
...
cd /opt/logicmoo_workspace/packs_sys/logicmoo_opencog/MeTTa/vspace-metta/T
cd /opt/logicmoo_workspace/packs_sys/logicmoo_opencog/MeTTa/vspace-metta/
ls ./precomputed_files/collaborators/pmid_fbgn_uniprot_fb_2023_05.tsv
tail ./precomputed_files/collaborators/pmid_fbgn_uniprot_fb_2023_05.tsv.datalog
ls ./precomputed_files/collaborators/pmid_fbgn_uniprot_fb_2023_05.*
vi add_lines.sh
chmod +x add_lines.sh 
ls  /opt/logicmoo_workspace/packs_sys/logicmoo_opencog/MeTTa/vspace-metta/precomputed_files/collaborators/pmid_fbgn_uniprot_fb_2023_05.tsv.metta.datalog
./add_lines.sh data/whole_flybase.metta.datalog  /opt/logicmoo_workspace/packs_sys/logicmoo_opencog/MeTTa/vspace-metta/precomputed_files/collaborators/pmid_fbgn_uniprot_fb_2023_05.tsv.metta.datalog
gunzip whole_flybase.qlf.gz
./MeTTa
swipl
./MeTTa -l whole_flybase.qlf 
./MeTTa -l whole_flybase.qlf ==repl
./MeTTa -l whole_flybase.qlf --repl
./MeTTa -f whole_flybase.qlf --repl
ls ./~temp~/
cp ./~temp~/fb.qlf .
./MeTTa -f fb.qlf --repl
ls ./~temp~/
cp ./~temp~/flybase_metta.qlf .
./MeTTa -f flybase_metta.qlf --repl
cp flybase_metta.qlf ./data/whole_flybase.qlf
gzip -k ./data/whole_flybase.qlf
git status .
git commit -am "Instatter for VSPAce"
git push logicmoo 
git push
metta 1-VSpaceTest.metta 
cd /opt/logicmoo_workspace/packs_sys/logicmoo_opencog/MeTTa/vspace-metta/T
...
git push
docker build . -t mettalog
git commit -am "testing docker so need this commited 234"
git push
docker build . -t mettalog
docker run --rm -it --entrypoint bash mettalog
git status .
