...
We''ve developed equivalent Prolog predicates and structures to simulate the functional behavior of MeTTa while maintaining logical coherence and semantic integrity.
So far, MeTTa in all cases map neatly into Prolog�s constructs.

## Transpiling MeTTa to Prolog

1. **Semantics Preservation:** Establishing equivalences that maintain intact semantics is pivotal, given the different evaluation strategies and paradigms in MeTTa and Prolog.

3. **Managing Contextual Information:** The management of contextual or environmental information within Prolog, analogous to a knowledge base in CYC, is also crucial.

2. **Handling Functional Constructs:** Translating MeTTa�s functional constructs to Prolog�s logical paradigm has its unique challenges, requiring suitable Prolog representations that simulate the functional behavior of MeTTa expressions.

A MeTTa function like:
```MeTTa
(= (add $X $Y) (+ $X $Y))
```
Transpiles to a Prolog predicate as:
```prolog
add(X, Y, ResVal) :- ResVal is X + Y.
```
This transformation ensures the preservation of the original semantics of the addition in MeTTa within the logical paradigm of Prolog.

### Testing:
Extensive testing is paramount to validate the correctness of the transpiled Prolog code.   We have  test cases to ensure the translated Prolog predicates mirror the behavior of the corresponding MeTTa functions accurately. The developed testing suite is integral to verifying the reliability and accuracy of the transpiled code.

| Directory                                        | Pass | Fail |Percent|
|--------------------------------------------------|------|------|-------|
|reports -                                         |   190|    35|    84%|
|reports/compat -                                  |   159|    33|    82%|
|reports/compat/common -                           |    10|     1|    90%|
|reports/compat/minecraft -                        |     0|     6|     0%|
|reports/compat/prob-dep-types -                   |     9|     0|   100%|
|reports/compat/test_scripts -                     |   140|    26|    84%|
...
| PASS | [TEST-SCRIPTS.C1-GROUNDED-BASIC.08](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/c1_grounded_basic.html#TEST-SCRIPTS.C1-GROUNDED-BASIC.08) | (assertEqualToResult (> 4 (+ $X 2))) | ((> 4 (+ $_94202 2))) | ((> 4 (+ $_89142 2))) |
...
| PASS | [TEST-SCRIPTS.E2-STATES.02](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/e2_states.html#TEST-SCRIPTS.E2-STATES.02) | (assertEqual (get-token)) | ((State  (A B) $_128438)) | ((State  (A B) $_129036)) |
...
| FAIL | [TEST-SCRIPTS.E2-STATES.07](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/e2_states.html#TEST-SCRIPTS.E2-STATES.07) | (assertEqual (change-state! &state-token 1)) | ((State  1 $_408950)) | ((Error 1 BadType)) |
| FAIL | [TEST-SCRIPTS.E2-STATES.08](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/e2_states.html#TEST-SCRIPTS.E2-STATES.08) | (assertEqual (change-state! (new-state 1) "S")) | ((State  "S" $_459256)) | ((Error "S" BadType)) |
...
| PASS | [TEST-SCRIPTS.E2-STATES.10](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/e2_states.html#TEST-SCRIPTS.E2-STATES.10) | (assertEqual (let $X (new-state 1) (change-state! $X (+ (get-state $X) 1)))) | ((State  2 $_59128)) | ((State  2 $_59386)) |
| PASS | [TEST-SCRIPTS.E2-STATES.11](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/e2_states.html#TEST-SCRIPTS.E2-STATES.11) | (assertEqual (let $Tnso (new-state 1) $Tnso)) | ((State  1 $_95980)) | ((State  1 $_96238)) |
...
| PASS | [TEST-SCRIPTS.E3-MATCH-STATES.05](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/e3_match_states.html#TEST-SCRIPTS.E3-MATCH-STATES.05) | (assertEqual &state-active) | ((State  inactive $_151764)) | ((State  inactive $_152022)) |
...
| FAIL | [TEST-SCRIPTS.F1-IMPORTS.01](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/f1_imports.html#TEST-SCRIPTS.F1-IMPORTS.01) | (assertEqual ((let $X (get-atoms &self) (get-type $X)))) | (((let $_481802 (get-atoms &self) (get-type $_481802)))) | ((Symbol)) |
...
# MeTTaLog: A Modern Logic-Based Programming Language

MeTTaLog is a superfluous implementation of MeTTa, a language designed to succeed OpenCog Classic Atomese. It is part of the OpenCog Hyperon initiative and provides well-defined semantics for meta-language features, different types of inference, and more.
This talk outlines the design principles and key features of MeTTaLog, a logic-based programming language designed to address the limitations of Prolog while providing accessibility and power for various applications.

## Introduction and Motivation

- Prolog is a powerful but often considered difficult and outdated language.
- It has issues like implicit nondirectionality, non-determinism, and non-logical features that can lead to confusion and misuse.
- The lack of language constructs and libraries for everyday programming tasks is a significant drawback.
- Several successors to Prolog have been attempted, but they had their own limitations.

## MeTTaLog's Objectives

- MeTTaLog aims to be a simple yet powerful logic-based programming language.
- It incorporates features from logic programming, functional programming, and scripting languages.
- It strives to maintain Prolog's strengths while addressing its weaknesses.
- MeTTaLog is designed to be a general-purpose language suitable for a wide range of applications.

## Key Features of MeTTaLog

- **Pattern-Matching**: Predicates and functions are defined using pattern-matching rules, allowing for zero, one, or multiple answers.

- **Imperative Features**: MeTTaLog includes assignment and loop statements for everyday programming tasks. Assignable variables are used for more complex computations.

- **Constraints**: Supports constraint programming, where variables have domains of possible values and constraints limit acceptable assignments.

- **Actors**: Actors are used for event-driven programming, with rules for describing behaviors. Threads are treated as channels for concurrent programming.

- **Tabling**: Allows for the storage and quick retrieval of calculated results, useful for dynamic programming solutions.

## Expressiveness and Reliability

- MeTTaLog is claimed to be more expressive than Prolog for scripting and modeling, often requiring significantly fewer lines of code.

- Pattern-matching and unification facilitate rule indexing, improving reliability.

- Explicit non-determinism, unification, a simple static module system, dynamic predicates, and operator overloading enhance language reliability.

## Metaprogramming

- MeTTaLog is mentioned as being capable of powerful metaprogramming, including the possibility of writing a meta-interpreter for MeTTaLog in MeTTaLog itself.

In summary, MeTTaLog is presented as a modern logic-based programming language that aims to combine the strengths of Prolog with improvements in usability, expressiveness, and reliability. It incorporates features from various programming paradigms, making it suitable for a wide range of applications, from symbolic computation to everyday scripting and modeling tasks.


We've developed equivalent Prolog predicates and structures to simulate the functional behavior of MeTTa while maintaining logical coherence and semantic integrity. So far, MeTTa in all cases map neatly into Prolog�s constructs.
## Transpiling MeTTa to Prolog

### Semantics Preservation
Establishing equivalences that maintain intact semantics is pivotal, given the different evaluation strategies and paradigms in MeTTa and Prolog.

### Managing Contextual Information
The management of contextual or environmental information within Prolog, analogous to a knowledge base in CYC, is also crucial.

### Handling Functional Constructs
Translating MeTTa�s functional constructs to Prolog�s logical paradigm has its unique challenges, requiring suitable Prolog representations that simulate the functional behavior of MeTTa expressions.
...
|--------------------------------------------------|------|------|-------|
|reports -                                         |   226|    51|    81%|
|reports/compat -                                  |   193|    48|    80%|
|reports/compat/common -                           |    11|     1|    91%|
|reports/compat/minecraft -                        |     0|     6|     0%|
|reports/compat/prob-dep-types -                   |     9|     0|   100%|
|reports/compat/test_scripts -                     |   173|    41|    80%|
|reports/nars -                                    |     7|     0|   100%|
|reports/nars_extras -                             |     0|     0|     0%|
...
|  0  |  0  | d5_auto_types.metta               |[reports/compat/test_scripts/d5_auto_types.html](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/d5_auto_types.html)|
|  0  |  0  | factorial.metta                   |[reports/factorial.html](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/factorial.html)|
...
| PASS | [TEST-SCRIPTS.C1-GROUNDED-BASIC.06](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/c1_grounded_basic.html#TEST-SCRIPTS.C1-GROUNDED-BASIC.06) | (assertEqualToResult (ln (+ 2 2))) | ((ln 4)) | ((ln 4)) |
| PASS | [TEST-SCRIPTS.C1-GROUNDED-BASIC.07](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/c1_grounded_basic.html#TEST-SCRIPTS.C1-GROUNDED-BASIC.07) | (assertEqualToResult (> 4 (+ ln 2))) | ((> 4 (+ ln 2))) | ((> 4 (+ ln 2))) |
| PASS | [TEST-SCRIPTS.C1-GROUNDED-BASIC.08](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/c1_grounded_basic.html#TEST-SCRIPTS.C1-GROUNDED-BASIC.08) | (assertEqualToResult (> 4 (+ $X 2))) | ((> 4 (+ $_171142 2))) | ((> 4 (+ $_165690 2))) |
| PASS | [TEST-SCRIPTS.C1-GROUNDED-BASIC.09](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/c1_grounded_basic.html#TEST-SCRIPTS.C1-GROUNDED-BASIC.09) | (assertEqualToResult (== 4 (+ 2 2))) | (True) | (True) |
| PASS | [TEST-SCRIPTS.C1-GROUNDED-BASIC.10](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/c1_grounded_basic.html#TEST-SCRIPTS.C1-GROUNDED-BASIC.10) | (assertEqualToResult (== 2 3)) | (False) | (False) |
| PASS | [TEST-SCRIPTS.C1-GROUNDED-BASIC.11](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/c1_grounded_basic.html#TEST-SCRIPTS.C1-GROUNDED-BASIC.11) | (assertEqualToResult (== (A B) (A B))) | (True) | (True) |
| PASS | [TEST-SCRIPTS.C1-GROUNDED-BASIC.12](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/c1_grounded_basic.html#TEST-SCRIPTS.C1-GROUNDED-BASIC.12) | (assertEqualToResult (== (A B) (A (B C)))) | (False) | (False) |
...
| FAIL | [TEST-SCRIPTS.E1-KB-WRITE.02](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/e1_kb_write.html#TEST-SCRIPTS.E1-KB-WRITE.02) | (assertEqualToResult (match &kb (Green $X) $X)) | (Fritz) | (Fritz Sam) |
| PASS | [TEST-SCRIPTS.E2-STATES.01](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/e2_states.html#TEST-SCRIPTS.E2-STATES.01) | (assertEqual (get-state (get-token))) | ((A B)) | ((A B)) |
| PASS | [TEST-SCRIPTS.E2-STATES.02](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/e2_states.html#TEST-SCRIPTS.E2-STATES.02) | (assertEqual (get-token)) | ((State  (A B) $_203230)) | ((State  (A B) $_203828)) |
| FAIL | [TEST-SCRIPTS.E2-STATES.03](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/e2_states.html#TEST-SCRIPTS.E2-STATES.03) | (assertEqual (get-type (new-state 2))) | ((Symbol Number)) | ((StateMonad Number)) |
| FAIL | [TEST-SCRIPTS.E2-STATES.04](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/e2_states.html#TEST-SCRIPTS.E2-STATES.04) | (assertEqual (get-type (change-state! (new-state "S") "V"))) | ((Symbol (Symbol String) String)) | ((StateMonad String)) |
| PASS | [TEST-SCRIPTS.E2-STATES.05](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/e2_states.html#TEST-SCRIPTS.E2-STATES.05) | (assertEqual (let $V (new-state 1) (get-type $V))) | ((StateMonad Number)) | ((StateMonad Number)) |
| FAIL | [TEST-SCRIPTS.E2-STATES.06](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/e2_states.html#TEST-SCRIPTS.E2-STATES.06) | (assertEqual (get-type &state-token)) | ((StateMonad (Symbol Symbol))) | ((StateMonad Expression)) |
| FAIL | [TEST-SCRIPTS.E2-STATES.07](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/e2_states.html#TEST-SCRIPTS.E2-STATES.07) | (assertEqual (change-state! &state-token 1)) | ((State  1 $_456526)) | ((Error 1 BadType)) |
| FAIL | [TEST-SCRIPTS.E2-STATES.08](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/e2_states.html#TEST-SCRIPTS.E2-STATES.08) | (assertEqual (change-state! (new-state 1) "S")) | ((State  "S" $_501468)) | ((Error "S" BadType)) |
| PASS | [TEST-SCRIPTS.E2-STATES.09](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/e2_states.html#TEST-SCRIPTS.E2-STATES.09) | (assertEqual (get-state (get-token))) | ((C D)) | ((C D)) |
| PASS | [TEST-SCRIPTS.E2-STATES.10](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/e2_states.html#TEST-SCRIPTS.E2-STATES.10) | (assertEqual (let $X (new-state 1) (change-state! $X (+ (get-state $X) 1)))) | ((State  2 $_86286)) | ((State  2 $_86544)) |
| PASS | [TEST-SCRIPTS.E2-STATES.11](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/e2_states.html#TEST-SCRIPTS.E2-STATES.11) | (assertEqual (let $Tnso (new-state 1) $Tnso)) | ((State  1 $_118528)) | ((State  1 $_118786)) |
| PASS | [TEST-SCRIPTS.E3-MATCH-STATES.01](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/e3_match_states.html#TEST-SCRIPTS.E3-MATCH-STATES.01) | (assertEqual (get-state (status (Goal lunch-order)))) | (inactive) | (inactive) |
| FAIL | [TEST-SCRIPTS.E3-MATCH-STATES.02](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/e3_match_states.html#TEST-SCRIPTS.E3-MATCH-STATES.02) | (assertEqual (get-state (status (Goal lunch-order)))) | (inactive) | (active) |
| PASS | [TEST-SCRIPTS.E3-MATCH-STATES.03](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/e3_match_states.html#TEST-SCRIPTS.E3-MATCH-STATES.03) | (assertEqual (get-type &state-active)) | ((StateMonad Symbol)) | ((StateMonad Symbol)) |
| PASS | [TEST-SCRIPTS.E3-MATCH-STATES.04](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/e3_match_states.html#TEST-SCRIPTS.E3-MATCH-STATES.04) | (assertEqual (get-state &state-active)) | (inactive) | (inactive) |
| PASS | [TEST-SCRIPTS.E3-MATCH-STATES.05](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/e3_match_states.html#TEST-SCRIPTS.E3-MATCH-STATES.05) | (assertEqual &state-active) | ((State  inactive $_400230)) | ((State  inactive $_400488)) |
| FAIL | [TEST-SCRIPTS.E3-MATCH-STATES.06](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/e3_match_states.html#TEST-SCRIPTS.E3-MATCH-STATES.06) | (assertEqual (match &self (= (status (Goal $Goal)) &state-active) $Goal)) | () | (meditation) |
| FAIL | [TEST-SCRIPTS.E3-MATCH-STATES.07](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/e3_match_states.html#TEST-SCRIPTS.E3-MATCH-STATES.07) | (assertEqual (if (== (get-state (status (Goal $Goal))) active) $Goal (superpose ()))) | () | (lunch-order) |
| FAIL | [TEST-SCRIPTS.F1-IMPORTS.01](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/f1_imports.html#TEST-SCRIPTS.F1-IMPORTS.01) | (assertEqual ((let $X (get-atoms &self) (get-type $X)))) | (((let $_78262 (get-atoms &self) (get-type $_78262)))) | ((Symbol)) |
| PASS | [TEST-SCRIPTS.F1-IMPORTS.02](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/f1_imports.html#TEST-SCRIPTS.F1-IMPORTS.02) | (assertEqual (if (> 1 2) 1 2)) | (2) | (2) |
| PASS | [TEST-SCRIPTS.F1-IMPORTS.03](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/f1_imports.html#TEST-SCRIPTS.F1-IMPORTS.03) | (assertEqual (+ 1 2)) | (3) | (3) |
| FAIL | [TEST-SCRIPTS.F1-IMPORTS.04](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/f1_imports.html#TEST-SCRIPTS.F1-IMPORTS.04) | (assertEqual (let* (($X (collapse (get-atoms &m))) ($Y (car-atom $X))) (get-type $Y))) | () | (Symbol) |
| PASS | [TEST-SCRIPTS.F1-IMPORTS.05](https://htmlpreview.github.io/?https://raw.githubusercontent.com/logicmoo/vspace-metta/main/reports/compat/test_scripts/f1_imports.html#TEST-SCRIPTS.F1-IMPORTS.05) | (assertEqual (match &m (= (f 2) $X) $X)) | ((g 3)) | ((g 3)) |
